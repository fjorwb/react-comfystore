...
const CheckoutForm = () => {
	...
	return (
		<div>
			{succeeded ? (
				<article>
					<h4 className="success-msg">Thank you</h4>
					<h4 className="success-msg">Your payment was successful!</h4>
					<h4 className="success-msg">Redirecting to home page shortly</h4>
				</article>
			) : (
				<article>
					<p style={{ fontSize: '1.5rem', fontWeight: '500' }}>Hello, {myUser && myUser.name}</p>
